...
const AddSpouseModal = ({ person, onSave, onClose }) => {
  const [formData, setFormData] = useState({
    name: '',
    gender: person.gender === 'male' ? 'female' : 'male', // Default to opposite gender
    birthDate: '',
    deathDate: '',
    isDeceased: false,
    description: '',
  ...
  const handleSubmit = (e) => {
    ...
    onSave(newSpouse, person, formData.marriageDate);
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h2 style={{ margin: 0, fontSize: '20px' }}>Add Spouse to {person.name}</h2>
          <button
            onClick={onClose}
            style={{
              background: 'none',
